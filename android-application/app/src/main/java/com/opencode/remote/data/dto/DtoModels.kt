...
/** Matches the bridge's NOTIFY payload (main.js notifyExternal): a free-text kind
 *  ("permission_request", "error", "task_completed" today — no fixed vocabulary
 *  enforced, same tolerant-string philosophy as AGENT_STATE) plus a kind-specific
 *  detail object read only for known string fields, never blindly trusted. */
@Serializable
